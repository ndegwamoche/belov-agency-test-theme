 ...
 *
 * This template renders a custom block on the frontend, displaying a featured article
 * alongside a list of related articles. The data is retrieved using Advanced Custom Fields (ACF).
 *
            ...
            <div class="featured-article">
                <div class="article-image">
                    <a href="<?php echo esc_url(get_permalink($featured_article->ID)); ?>">
                        <img
                            src="<?php echo esc_url(get_the_post_thumbnail_url($featured_article->ID, 'full') ?: get_theme_file_uri('images/default-image.jpg')); ?>"
                            alt="<?php echo esc_attr($featured_article->post_title); ?>" />
                    </a>
                </div>
                <div class="article-content">
                    ...
                    ?>
                    <?php if ($category) : ?>
                        <a href="<?php echo esc_url(get_category_link($category->term_id)); ?>" class="btn article-category">
                    ...
                    <p class="article-author">
                        ...
                        <img src="<?php echo esc_url(get_theme_file_uri('images/separator-icon.svg')); ?>" alt="Dot icon">
                    ...
                    <article class="article-card">
                        <div class="article-image">
                            <a href="<?php echo esc_url(get_permalink($article->ID)); ?>">
                                <img
                                    src="<?php echo esc_url(get_the_post_thumbnail_url($article->ID, 'full') ?: get_theme_file_uri('images/default-image.jpg')); ?>"
